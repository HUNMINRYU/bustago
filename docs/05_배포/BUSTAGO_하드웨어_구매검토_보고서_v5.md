...
|------|------|:----:|----------:|----------:|------|
| AI 처리 장치 | NVIDIA Jetson Orin Nano Super Developer Kit | 1 | 550,000 | 550,000 | 한컴 460K / 디바이스마트 550K 확인. 신청서는 상한가 기준 권장 |
| 키오스크 장치 | Raspberry Pi 4 Model B (4GB RAM) | 1 | 166,000 | 166,000 | 쿠팡 현재 링크 기준 |
| 키오스크 장치 | Raspberry Pi 공식 7인치 터치 디스플레이 (800×480, DSI) | 1 | 132,000 | 132,000 | 기존 시연 해상도 유지 |
| 카메라 센서 | Raspberry Pi Camera Module V2 (IMX219, 8MP) | 1 | 26,400 | 26,400 | Jetson native 지원 계열 |
| 케이블 | 22P(0.5mm) → 15P(1mm) 카메라 케이블 300mm | 1 | 2,700 | 2,700 | Jetson ↔ Pi Camera 연결 필수 |
| 저장 장치 | microSD 64GB Class10 / UHS-I 이상 | 2 | 15,000 | 30,000 | Jetson 1장 + Pi 1장, 시연용 보수 단가 |
| 전원 장치 | 5V 3A USB-C 어댑터 (Pi 4용, KC 인증) | 1 | 6,200 | 6,200 | Pi 전원 |
| | **합계** | | | **913,300** | |

> **보수적 신청 총액:** **913,300원**
> **실제 지출 예상:** Jetson을 한컴앤샵 가격(460,000원)으로 구매하면 **약 823,300원**
> **예산 여유:** **86,700원 ~ 176,700원**
